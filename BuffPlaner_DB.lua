...
BuffPlaner_DefaultConfig = {
    ...
    buffs = {
        ...
        { key = "sun_mp5_cost_reduction",   name = "MP5 + Cost Reduction",         spellName = { "Devotion of Grace" }, icon = "spell_holy_mindvision", range = 40 },
        { key = "sun_ap",    name = "AP",          spellName = { "Devotion of Dawn" },  icon = "spell_holy_auramagister", range = 40 },
        { key = "sun_stats", name = "All Stats %",  spellName = { "Devotion of Emperors", "Devotion of Emperrors" }, icon = "spell_holy_greaterheal", range = 40 },
        ...
        { key = "cul_stats",    name = "All Stats %",          spellName = { "Whispers of N'Zoth" }, icon = "spell_holy_divineillumination", range = 30 },
        { key = "cul_reduce_spell_damage_taken_and_heal",    name = "Reduce Spell DMG taken and Heal",          spellName = { "Whispers of Yogg-Saron" }, icon = "spell_holy_divineillumination", range = 30 },
        ...
        { key = "run_stats",    name = "All Stats %",          spellName = { "Etching of the Leylines" }, icon = "spell_holy_divineillumination", range = 40 },
        ...
        { key = "ven_arm_stats",    name = "Armour + All Stats flat",          spellName = { "Beetle Pheromones" }, icon = "spell_holy_divineillumination", range = 40 },
        ...
        { key = "blo_inc_spell_dmg_taken_heal",    name = "Increase Spell DMG Taken and Heal",          spellName = { "Slaughterhouse Offering" }, icon = "spell_holy_divineillumination", range = 40 },
        ...
        { key = "fel_arm_stats",    name = "Armour + All Stats flat",          spellName = { "Man'ari Intuition" }, icon = "spell_holy_divineillumination", range = 40 },
        ...
        { key = "wit_doc_arm_stats",    name = "Armour + All Stats flat",          spellName = { "Knight's Edict" }, icon = "spell_holy_divineillumination", range = 40 },
        ...
        { key = "kox_stamina_frost",    name = "Stamina + Frost Resi",          spellName = { "Mark of Rivendare" }, icon = "spell_holy_divineillumination", range = 40 },
        { key = "kox_cost_reduction_arcane",    name = "Cost Reduction + Arcane Resi",          spellName = { "Mark of Zeliek" }, icon = "spell_holy_divineillumination", range = 40 },
        { key = "kox_sp_shadow",    name = "SP + Shadow Resi",          spellName = { "Mark of Blaumeux" }, icon = "spell_holy_divineillumination", range = 40 },
        { key = "kox_str_fire",    name = "STR + Fire Resi",          spellName = { "Mark of Korth'azz" }, icon = "spell_holy_divineillumination", range = 40 },
        { key = "tem_stats",    name = "All Stats %",          spellName = { "Gift of Fervor" }, icon = "spell_holy_divineillumination", range = 40 },
        { key = "tem_agi",    name = "AGI",          spellName = { "Gift of Zeal" }, icon = "spell_holy_divineillumination", range = 40 },
        { key = "ran_arm_stats",    name = "Armour + All Stats flat",          spellName = { "Foorpad's Adaptation" }, icon = "spell_holy_divineillumination", range = 40 },
